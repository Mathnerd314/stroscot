...
- Maxima, Axiom and its two (!) forks, SymPy, REDUCE, Symbolics.jl, Mathics, SageMath, FORM, Yacas, Xcas, Oscar.jl, Macaulay2, Singular, [emmy](https://github.com/mentat-collective/emmy/tree/main) - Axiom (or one of its forks) is probably the best-designed "winner" that everybody should copy (Lisp-based)
