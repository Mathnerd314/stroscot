...
* interesting design process (`Wikipedia <https://en.wikipedia.org/wiki/Ada_(programming_language)#History>`__): committee gathered requirements (resulting in Steelman report). 4 contractors put forward proposals - after two rounds, one was selected. The reference manual was written, and comments and corrections were received. The specification was then frozen and implementations were designed and validated.
* paradigm: imperative
