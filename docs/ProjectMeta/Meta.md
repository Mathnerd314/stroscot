...
Why another programming language, you may ask? Why does a painter paint? To paraphrase Chapter 1 of The Mythical Man Month, there is the joy of: [^tractable]
...
- [First commit](https://github.com/Mathnerd314/stroscot/tree/a5264d6697f3e4a4034c4acc87c2a2022070a2bc): December 2018
- [Bus factor](https://en.wikipedia.org/wiki/Bus_factor): 1
- {{ [activity](https://img.shields.io/github/commit-activity/m/Mathnerd314/stroscot) }}
- {{ [loc](https://img.shields.io/tokei/lines/github/Mathnerd314/stroscot) }} (includes documentation)
...
These criticisms from the [programming language checklist](https://www.mcmillen.dev/language_checklist.html) seem valid.
