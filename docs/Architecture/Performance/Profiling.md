...
- memory
  ...
  - [profiler](https://blog.mozilla.org/jseward/2011/01/27/profiling-the-browsers-virtual-memory-behaviour/)
...
- [nanoBench](https://github.com/andreas-abel/nanoBench) - this has a kernel module to allow reading hardware performance counters for microbenchmarks without incurring much overhead
- [benchExec](https://github.com/sosy-lab/benchexec) - this is very similar to the tool I remember, but focused on limiting resources rather than getting precise measurements
- [hyperfine](https://github.com/sharkdp/hyperfine) - this does some basic warmup and statistics, useful as a baseline for the bare minimum of Benchmarking
- [temci](https://github.com/parttimenerd/temci) sets up an environment
